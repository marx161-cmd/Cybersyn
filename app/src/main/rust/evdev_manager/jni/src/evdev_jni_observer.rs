...
impl EvdevJniObserver {
    ...
    pub fn on_grabbed_devices_changed(&self, grabbed_devices: Vec<GrabbedDeviceHandle>) {
        ...
        if let Err(e) = env.call_method(
            ...
            "([Lcom/termux/cybersyn/core/evdev/GrabbedDeviceHandle;)V",
    ...
    pub fn on_evdev_devices_changed(&self, devices: Vec<EvdevDeviceInfo>) {
        ...
        let info_class =
            match env.find_class("com/termux/cybersyn/core/evdev/EvdevDeviceInfo") {
                Ok(c) => c,
                Err(e) => {
        ...
        if let Err(e) = env.call_method(
            ...
            "([Lcom/termux/cybersyn/core/evdev/EvdevDeviceInfo;)V",
            &[JValue::Object(&array.into())],
        ) {
