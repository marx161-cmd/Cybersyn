...
#[no_mangle]
pub extern "system" fn Java_com_termux_cybersyn_core_evdev_CybersynEvdevBridge_initEvdevManager(
    env: JNIEnv,
    this: JObject,
) {
    // Get the JavaVM
...
#[no_mangle]
pub extern "system" fn Java_com_termux_cybersyn_core_evdev_CybersynEvdevBridge_destroyEvdevManager(
    _env: JNIEnv,
    _class: JClass,
) {
...
#[no_mangle]
pub extern "system" fn Java_com_termux_cybersyn_core_evdev_CybersynEvdevBridge_setLogLevelNative(
    _env: JNIEnv,
    _class: JClass,
    level: jint,
) {
...
#[no_mangle]
pub extern "system" fn Java_com_termux_cybersyn_core_evdev_CybersynEvdevBridge_setGrabTargetsNative(
    mut env: JNIEnv,
    _class: JClass,
...
#[no_mangle]
pub extern "system" fn Java_com_termux_cybersyn_core_evdev_CybersynEvdevBridge_writeEvdevEventNative(
    _env: JNIEnv,
    _class: JClass,
    j_device_id: jint,
    j_type: jint,
...
/// Write an event to a grabbed device using its device ID
#[no_mangle]
pub extern "system" fn Java_com_termux_cybersyn_core_evdev_CybersynEvdevBridge_writeEvdevEventKeyCodeNative(
    _env: JNIEnv,
    _class: JClass,
    j_device_id: jint,
    j_key_code: jint,
...
#[no_mangle]
pub extern "system" fn Java_com_termux_cybersyn_core_evdev_CybersynEvdevBridge_getEvdevDevicesNative(
    mut env: JNIEnv,
    _class: JClass,
) -> jobjectArray {
    ...
    // Create Java array
    let class = match env.find_class("com/termux/cybersyn/core/evdev/EvdevDeviceInfo") {
        Ok(c) => c,
        Err(e) => {
...
fn create_java_grabbed_device_handle_array(
    ...
    let handle_class =
        match env.find_class("com/termux/cybersyn/core/evdev/GrabbedDeviceHandle") {
            Ok(c) => c,
            Err(e) => {
...
fn create_java_evdev_device_info(
    ...
    let class = env.find_class("com/termux/cybersyn/core/evdev/EvdevDeviceInfo")?;
...
fn create_java_grabbed_device_handle(
    ...
    let class = env.find_class("com/termux/cybersyn/core/evdev/GrabbedDeviceHandle")?;
    let name_str = env.new_string(name)?;
