...
object ProfileTemplateCatalog {
    val all: List<ProfileTemplate> = listOf(
        ...
        ProfileTemplate(
            ...
            actions = listOf(
                TemplateAction("notify.show", "Show arrival notification", mapOf("title" to "Cybersyn", "text" to "{message}")),
        ...
        ProfileTemplate(
            ...
            actions = listOf(
                ...
                TemplateAction("notify.show", "Show app reminder", mapOf("title" to "Cybersyn reminder", "text" to "{message}")),
            ),
        ),
        ProfileTemplate(
            id = "find-my-phone",
